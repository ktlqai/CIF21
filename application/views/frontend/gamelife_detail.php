     ...
     <div class="clear"></div><!--.clear-->
            ...
            <div id="wrapper">
            		<div id="left" style="height:auto; margin-bottom:20px">
                    	<div>
                        	<?php foreach($gamelife_title_for_gamelife_detail as $gtfgd)
							{
								echo "<h3 style='color:#09F'>" .$gtfgd['new_quote']. "</h3>". "<p align='right'>".date("F j, Y, g:i a")."</p>";
								echo "<br />";
								echo "<b>" .$gtfgd['new_content']. "</b>";
							}
                            ?>
                        </div>
                        <div class="clear"></div>
