     ...
     <div class="clear"></div><!--.clear-->
            ...
            <div id="wrapper">
                  ...
                  <?php foreach($new_title_for_new_detail as $ntfnd)
                    	...
                    	<div id="new_detail">
                        	<?php foreach($rating_board_item_detail as $rbid)
							{
								echo $rbid['new_content_detail'];
							}
							?>
                    	</div><!--#new_detail-->
                                    	<div id="news_other">
                               ...
                               <div align="left">
       	&raquo;<b>Ý kiến của bạn đọc</b>&nbsp;( hiện có :&nbsp;<?php if(!is_null($count_all_comment_each_new)) echo $count_all_comment_each_new;?> bình luận về bài viết này. )
       							</div>       
