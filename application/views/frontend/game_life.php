     ...
     <div class="clear"></div><!--.clear-->
            ...
            <div id="wrapper">
            		<div id="left">
                     ...
                     <div class="title"><img src="<?php echo $frontend_image; ?>/image-stuff/game-va-doi-song.jpg" /></div><!--#left .title-->
                    	<div class="recent_update_feature">
                     <?php foreach($game_life_1 as $fgl)
					 {?>
                 <div class="images">
                 <a href="<?php echo base_url();?>home/gamelife_detail/<?php echo $fgl['new_id'];?>">       
             <img src="<?php echo $frontend_image; ?>/image-new/<?php echo $fgl['new_image'];?>" width="340px" height="230px" />
             	</a>
                </div><!--.images-->
                            <div class="content">
                            <a href="<?php echo base_url();?>home/gamelife_detail/<?php echo $fgl['new_id'];?>">
                            	<h3><?php echo $fgl['new_quote'];?></h3>
                           </a>   
                                <br />
                              <p><?php echo $fgl['new_content'];?></p>
              ...
              ?>          
                        ...
                        <?php foreach($game_life_2 as $gl_2)
						{?>
                        <div class="recent_update_items">
                       <div class="images">
                       <a href="<?php echo base_url();?>home/gamelife_detail/<?php echo $gl_2['new_id'];?>">
                       		<img src="<?php echo $frontend_image; ?>/image-new/<?php echo $gl_2['new_image'];?>" width="200px" height="130px" />
                       </a>
                       </div><!--.recent_update_items .images-->
                            <div class="content">
                            <h5>
                            	<a href="<?php echo base_url();?>home/gamelife_detail/<?php echo $gl_2['new_id'];?>">
							<?php echo $gl_2['new_quote'];?>
                            	</a>
                            </h5>
                            	<br />
                            <p><?php echo $gl_2['new_content'];?></p>
