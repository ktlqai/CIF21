     ...
     <div class="clear"></div><!--.clear-->
            ...
            <div id="wrapper">
            		<div id="left" style="height:auto; margin-bottom:20px">
                    	<div>
                        	<?php foreach($title_slider_for_slider_detail as $tsfsd)
							{
								echo "<h3 style='color:#09F'>" .$tsfsd['slider_title']. "</h3>". "<p align='right'>".date("F j, Y, g:i a")."</p>";
								echo "<br />";
								echo "<b>".$tsfsd['slider_content']."</b>";
							}
                            ?>
                        </div>
                        <div class="clear"></div>
